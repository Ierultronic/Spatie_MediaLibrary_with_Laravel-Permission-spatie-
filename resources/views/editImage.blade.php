    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="{{ route('store.post',Auth::user()->id)}}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="desc" type="text" class="form-control @error('desc') is-invalid @enderror" value="{{$posts->Description}}" name="desc" required autocomplete="desc" autofocus>
